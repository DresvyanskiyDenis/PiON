...
Four decisions shape most of what is surprising about this repository. They are recorded here so a
...
| [0004](0004-egress-classes-are-declarative.md) | Egress classes are a declarative control and are never described as a network boundary | Accepted |
