...
Thirty-seven modules, composed into one PI extension by `extensions/index.ts`. Each exports `id` and
...
| 5 | Observability and lifecycle | [quota](quota.md), [subagent-cost](subagent-cost.md), [digest](digest.md), [compaction](compaction.md), [context-report](context-report.md), [context-imports](context-imports.md), [session-index](session-index.md), [auto-title](auto-title.md), [auto-update](auto-update.md), [skills-lint](skills-lint.md), [thinking-indicator](thinking-indicator.md), [loader-clock](loader-clock.md), [write-diff](write-diff.md) |
