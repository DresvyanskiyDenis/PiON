...
|---|---|---|
| **Holds** | Structured reference: architecture, every configuration key, all 31 modules, the safety model, exit codes | Recipes, FAQ, troubleshooting, cheat sheets, release notes |
